...
import { LineChart, Area, AreaChart, Line, BarChart, Bar, PieChart, Pie, Cell, Tooltip, XAxis, YAxis, CartesianGrid, Legend, ResponsiveContainer } from "recharts";
...
>
  ...
  <div className="flex flex-col sm:flex-row gap-6 w-full items-center justify-center">
    ...
    dy: 10, 
          ...
          />
          <Legend wrapperStyle={{ fontSize: 7 , marginTop : 60}} />
